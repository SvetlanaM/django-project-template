...
SECRET_KEY = env(
    "DJANGO_SECRET_KEY",
    default="dtWjxFqbGdsKdChL4cibQcYuTZAVJHOm2ozCooncfbrh7y2WDgJ9Zpn2MCILcITL",
)
...
SITE_ID = 1  # if it doesn't exist sites framework will pick up based on domain
...
ADMIN_PAGE = "sveta_template.admin.SvetaAdmin"
...
DJANGO_APPS = [
    ...
    "sveta_template.apps.SvetaAdminConfig",
    "django.forms",
]
...
# TODO: DJANGO_DEFAULT_FROM_EMAIL per White-label
